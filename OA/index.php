  ...
  <div class="container" id="main_container">
    ...
    <div class="row">
    	...
    	while($row = mysqli_fetch_array($result)) {
		  echo '<div class="grid_4"><div class="banner">
		  <div class="gall_block">
		  <a href="Admin/upload/'.$row["foto"].'">
          <img class="oa_img" src="Admin/upload/'.$row["foto"].'" alt=""></a>
         <div class="block1">';
  ...
  <div class="container">
    <div class="row">
      <div class="grid_12">  
        ...
        <div class="copyright"><span class="brand">OptimusArchitechture</span> &copy; <span id="copyright-year"></span> | <a href="#"></a>
        </div>
      </div>
    </div>
  </div> 
